<!DOCTYPE html>
<?php
$con=mysql_connect("loacl host","root","","techbox");
	if(!$con)
	{
		echo "not connected";
	}
        ...
        <ul class="list-unstyled components">
            <li class="active">
                ...
                <ul class="collapse show list-unstyled" id="homeSubmenu">
				   ...
				   $catqueryresult= mysqli_query($con,scatquery);
				   while($row=mysqli_fetch_assoc()$catqueryresult)
				   {
					   echo "<li><a class='nay-link' href='#'>".$row['cat_title']."</a\>
					   </li>";
				   }
				   ?>
                </ul>
            ...
            <li class="active">
				...
				<?php
					   $catquery = select * from brand;
						  ...
						  while($row=mysqli_fetch_assoc()$catqueryresult)
				   {
					   echo "<li><a class='nay-link' href='#'>".$row['brand_title']."</a\>
										}
					?>
					   </li>";
